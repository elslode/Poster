...
import slode.elsloude.mymoview.adapters.ReviewAdapter;
import slode.elsloude.mymoview.adapters.TrailerAdapter;
import slode.elsloude.mymoview.data.FavouriteMovie;
...
public class DetailActivity extends AppCompatActivity {
    ...
    public void onClickChangeFavorite(View view) {
        if (favouriteMovie == null) {
            ...
            Toast.makeText(this, R.string.AddToFavourite, Toast.LENGTH_SHORT).show();
        } else {
            viewModel.deleteFavouriteMovie(favouriteMovie);
            Toast.makeText(this, R.string.RemoveFromFavourite, Toast.LENGTH_SHORT).show();
        }
        setFavourite();
    }
    ...
    private void setFavourite() {
        ...
        if (favouriteMovie == null) {
            imageViewAddToFavourite.setImageResource(R.drawable.starspoloya);
        } else {
            imageViewAddToFavourite.setImageResource(R.drawable.starsyelow);
        }
    }
}