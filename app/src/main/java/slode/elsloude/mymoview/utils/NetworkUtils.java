...
public class NetworkUtils {
    ...
    private static final String PARAMS_MIN_VOTE_COUNT = "vote_count.gte"; //параметр минимальное количество голосов за фильм
    ...
    private static final String MIN_VOTE_COUNT_VALUE = "1000"; //минимальное количество голосов за фильм
    ...
    public static URL bildURLToReviews(int id) {
    ...
    public static URL buildURLToVideos(int id) {
        Uri uri = Uri.parse(String.format(BASE_URL_VIDEOS, id)).buildUpon()
                ...
                .appendQueryParameter(PARAMS_LANGUAGE, LANGEUAGE_VALUE).build();
        try {
            return new URL(uri.toString());
        } catch (MalformedURLException e) {
            e.printStackTrace();
